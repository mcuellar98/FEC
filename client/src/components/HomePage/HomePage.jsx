  ...
  return (
    <div style={{textAlign:'center'}}>
      ...
      <div id='pages'>
        {(pageNum === 1) ?
        (<u onClick={goNext}>&#60;</u>) : (<></>)}
        <u onClick={(e)=>{handleClick(e,1)}}>1</u>
        <u onClick={(e)=>{handleClick(e,2)}}>2</u>
        <u onClick={(e)=>{handleClick(e,3)}}>3</u>
        <u onClick={(e)=>{handleClick(e,4)}}>4</u>
        <u onClick={(e)=>{handleClick(e,5)}}>5</u>
        {(pageNum === 5) ?
        (<></>):(<u onClick={goBack}>&#62;</u>)}
      </div>
    </div>
